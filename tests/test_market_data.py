...
def test_fetch_and_cache_miss(temp_cache_dir, mock_yf_download):
    ...
    # 1. First call: miss
    df1 = _get_prices()("FAKE", "2023-01-01", "2023-01-05", cache_dir=temp_cache_dir)
...
def test_cache_hit(temp_cache_dir, mock_yf_download):
    ...
    mock_yf_download.return_value = mock_df
    _get_prices()("FAKE", "2023-01-01", "2023-01-05", cache_dir=temp_cache_dir)
    
    # Reset mock
    mock_yf_download.reset_mock()
    
    # 2. Second call: hit
    df2 = _get_prices()("FAKE", "2023-01-01", "2023-01-05", cache_dir=temp_cache_dir)
